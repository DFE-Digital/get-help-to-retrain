...
module GetHelpToRetrain
  class Application < Rails::Application
    ...
    config.azure_management_role_id = ENV['AZURE_MANAGEMENT_ROLE_ID'] || :manager
    config.azure_readwrite_role_id = ENV['AZURE_READWRITE_ROLE_ID'] || :readwrite
    config.azure_read_role_id = ENV['AZURE_READ_ROLE_ID'] || :read
  end
end
