...
RSpec.describe CourseDetails do
  ...
  describe '#provider_address_line_2' do
    context 'when both keys exist in the body' do
      it 'returns the correct provider address line 2' do
        expect(
  ...
  describe '#provider_postcode' do
    context 'when both keys exist in the body' do
      it 'returns the correct provider postcode' do
        expect(
  ...
  describe '#provider_county' do
    context 'when both keys exist in the body' do
      it 'returns the correct provider county' do
        expect(
  ...
  describe '#provider_phone' do
    context 'when both keys exist in the body' do
      it 'returns the correct provider phone' do
        expect(
  ...
  describe '#website' do
    context 'when the courseURL key exists in the body' do
      it 'returns the correct course website' do
        expect(
